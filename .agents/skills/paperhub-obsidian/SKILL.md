...
`.claude/skills/paperhub-obsidian/SKILL.md` from that root for the canonical
router, safeguards, attribution, and upstream-refresh workflow. Read only the
upstream module(s) selected by that router.
