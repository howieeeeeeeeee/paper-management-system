...
Use `update-paperhub-utils` to refresh PaperHub skills and utility code from the public template while preserving local papers, tags, API keys, runtime config, Obsidian state, generated outputs, and customized prompts.
